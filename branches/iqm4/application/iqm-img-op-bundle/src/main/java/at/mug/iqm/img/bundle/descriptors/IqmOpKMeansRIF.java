 ...
 * @since    2009 05
 */
public class IqmOpKMeansRIF implements RenderedImageFactory {

	public IqmOpKMeansRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpKMeansOpImage(pb.getRenderedSource(0),
