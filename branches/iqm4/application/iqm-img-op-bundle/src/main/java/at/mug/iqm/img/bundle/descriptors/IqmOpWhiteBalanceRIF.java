 ...
 * File: IqmOpWhiteBalanceRIF.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * @since   2009 12
 */
public class IqmOpWhiteBalanceRIF implements RenderedImageFactory {

	public IqmOpWhiteBalanceRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpWhiteBalanceOpImage(pb.getRenderedSource(0),
