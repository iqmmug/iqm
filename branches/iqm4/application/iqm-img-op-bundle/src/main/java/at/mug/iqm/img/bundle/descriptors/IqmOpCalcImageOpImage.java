 ...
 * File: IqmOpCalcImageOpImage.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class IqmOpCalcImageOpImage extends PointOpImage {
	...
	public IqmOpCalcImageOpImage(RenderedImage ri1, RenderedImage ri2,
			int calc, int resultOptions, ImageLayout layout,
