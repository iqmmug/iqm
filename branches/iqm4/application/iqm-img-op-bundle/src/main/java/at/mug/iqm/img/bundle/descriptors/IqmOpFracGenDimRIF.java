 ...
 * @since   2012 03
 */
public class IqmOpFracGenDimRIF implements RenderedImageFactory {

	public IqmOpFracGenDimRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracGenDimOpImage(pb.getRenderedSource(0),
