 ...
 * @since 2011 12
 */
public class IqmOpNexelScanRIF implements RenderedImageFactory {

	public IqmOpNexelScanRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpNexelScanOpImage(pb.getRenderedSource(0),
