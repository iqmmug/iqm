 ...
 * @since   2009 11
 */
public class IqmOpFracBoxRIF implements RenderedImageFactory {

	public IqmOpFracBoxRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracBoxOpImage(pb.getRenderedSource(0),
