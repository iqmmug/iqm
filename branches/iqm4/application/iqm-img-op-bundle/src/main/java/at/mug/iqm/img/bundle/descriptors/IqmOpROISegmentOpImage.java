 ...
 * File: IqmOpROISegmentOpImage.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class IqmOpROISegmentOpImage extends PointOpImage {

	private RenderedImage ri;
	private int method;
	private int binarize;

	public IqmOpROISegmentOpImage(RenderedImage ri, int method, int binarize,
