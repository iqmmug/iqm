 ...
 * @since 2010 05
 */
public class IqmOpDirLocalRIF implements RenderedImageFactory {

	public IqmOpDirLocalRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpDirLocalOpImage(pb.getRenderedSource(0),
