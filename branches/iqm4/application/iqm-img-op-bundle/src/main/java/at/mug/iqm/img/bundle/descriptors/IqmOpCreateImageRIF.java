 ...
 * @since    2010 02
 */
public class IqmOpCreateImageRIF implements RenderedImageFactory {

	public IqmOpCreateImageRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpCreateImageOpImage(pb.getRenderedSource(0),
