 ...
 * @since   2009 04
 */
public class IqmOpRGBRelativeRIF implements RenderedImageFactory {

	public IqmOpRGBRelativeRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpRGBRelativeOpImage(pb.getRenderedSource(0),
				...
				pb.getIntParameter(10), pb.getIntParameter(11),
				pb.getIntParameter(12), pb.getIntParameter(13),
				pb.getIntParameter(14), pb.getIntParameter(15), layout, hints,
				false);
	}
}
