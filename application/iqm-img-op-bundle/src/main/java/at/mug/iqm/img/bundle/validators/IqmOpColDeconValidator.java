 ...
 * File: IqmOpColDeconValidator.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class IqmOpColDeconValidator extends DefaultImageOperatorValidator {

	public IqmOpColDeconValidator() {
	}
				...
				if (box.getDataType() == DataType.IMAGE) {
					...
					if (ImageAnalyzer.has1Band(pi))
						throw new IllegalArgumentException(
								"This operator requires non-single band images only in the source vector!");
				}
			}
