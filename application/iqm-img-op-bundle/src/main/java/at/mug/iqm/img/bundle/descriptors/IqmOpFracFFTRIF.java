 ...
 * @since   2011 02
 */
public class IqmOpFracFFTRIF implements RenderedImageFactory {

	public IqmOpFracFFTRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracFFTOpImage(pb.getRenderedSource(0),
