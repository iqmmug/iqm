 ...
 * @since   2009 04
 */
public class IqmOpThresholdRIF implements RenderedImageFactory {

	public IqmOpThresholdRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpThresholdOpImage(pb.getRenderedSource(0),
				...
				pb.getIntParameter(8), pb.getIntParameter(9), layout, hints,
				false);
	}
}
