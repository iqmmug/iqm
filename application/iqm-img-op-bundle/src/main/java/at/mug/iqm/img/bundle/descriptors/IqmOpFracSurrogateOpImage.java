 ...
 * File: IqmOpFracSurrogateOpImage.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class IqmOpFracSurrogateOpImage extends PointOpImage {

	private RenderedImage ri;
	private int method;

	public IqmOpFracSurrogateOpImage(RenderedImage ri, int method,
