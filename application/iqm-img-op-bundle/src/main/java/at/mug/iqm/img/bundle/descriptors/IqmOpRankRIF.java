 ...
 * @since 2009 04
 */
public class IqmOpRankRIF implements RenderedImageFactory {
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpRankOpImage(pb.getRenderedSource(0),
				pb.getIntParameter(0), pb.getIntParameter(1),
				pb.getIntParameter(2), pb.getIntParameter(3),
				pb.getDoubleParameter(4), layout, hints, false);
	}
}
