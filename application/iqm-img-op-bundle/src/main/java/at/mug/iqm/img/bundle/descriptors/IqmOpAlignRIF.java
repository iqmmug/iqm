 ...
 * @since 2009 06
 */
public class IqmOpAlignRIF implements RenderedImageFactory {

	public IqmOpAlignRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpAlignOpImage(pb.getRenderedSource(0),
