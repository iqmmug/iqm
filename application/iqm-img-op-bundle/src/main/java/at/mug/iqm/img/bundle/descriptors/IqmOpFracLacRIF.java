 ...
 * @since   2011 04
 */
public class IqmOpFracLacRIF implements RenderedImageFactory {

	public IqmOpFracLacRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracLacOpImage(pb.getRenderedSource(0),
