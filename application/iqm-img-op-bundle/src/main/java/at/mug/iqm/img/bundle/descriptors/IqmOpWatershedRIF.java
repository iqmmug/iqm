 ...
 * @since   2010 05
 */
public class IqmOpWatershedRIF implements RenderedImageFactory {

	public IqmOpWatershedRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpWatershedOpImage(pb.getRenderedSource(0),
