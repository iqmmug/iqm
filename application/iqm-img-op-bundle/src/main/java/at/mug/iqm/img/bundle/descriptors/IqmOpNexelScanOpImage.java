 ...
 * File: IqmOpNexelScanOpImage.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class IqmOpNexelScanOpImage extends PointOpImage {
	...
	public IqmOpNexelScanOpImage(RenderedImage ri, int kernelShape,
			int kernelSize, int greyTolerance, int method, int resultOptions,
