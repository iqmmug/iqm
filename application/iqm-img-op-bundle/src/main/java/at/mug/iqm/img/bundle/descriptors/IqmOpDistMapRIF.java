 ...
 * 
 */
public class IqmOpDistMapRIF implements RenderedImageFactory {

	public IqmOpDistMapRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpDistMapOpImage(pb.getRenderedSource(0),
				pb.getIntParameter(0), pb.getIntParameter(1),
				pb.getIntParameter(2), pb.getIntParameter(3), layout, hints,
				false);
	}
}
