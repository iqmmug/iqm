 ...
 * @since 2009 06
 */
public class IqmOpBorderRIF implements RenderedImageFactory {

	public IqmOpBorderRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpBorderOpImage(pb.getRenderedSource(0),
