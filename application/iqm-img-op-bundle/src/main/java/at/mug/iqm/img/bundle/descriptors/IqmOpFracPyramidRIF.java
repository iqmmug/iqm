 ...
 * @since   2009 07
 */
public class IqmOpFracPyramidRIF implements RenderedImageFactory {

	public IqmOpFracPyramidRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracPyramidOpImage(pb.getRenderedSource(0),
