 ...
 * File: IqmOpStatRegMergeRIF.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * @since    2012 01
 */
public class IqmOpStatRegMergeRIF implements RenderedImageFactory {

	public IqmOpStatRegMergeRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpStatRegMergeOpImage(pb.getRenderedSource(0),
