 ...
 * File: IqmColor_Deconvolution.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * <b>Changes</b>
 * <ul>
 * 	<li>2010 11 new Color_Deconvolution version with new colors (H&E2, Masson Trichrome,..)
 * 	<li>2010 11 DAB, DAB NBTBCIP, colors 
 * </ul>
 * 
 * @author Helmut Ahammer
 * @since    2009 05
 */
public class IqmColor_Deconvolution {

	// Copyright (c) 2004-2010 Gabriel Landini
	...
	public  ImagePlus[] run(ImagePlus imp, String vectors) {
		...
		String myStain = vectors; 
		boolean doIshow = false;
		boolean hideLegend = true;
		...
		if (myStain.equals("Masson Trichrome")){
			// GL Methyl blue
			//			MODx[2]=1.0-0.7995107;
			//			MODy[2]=1.0-0.5913521;
			//			MODz[2]=1.0-0.10528667;
			//			// GL Ponceau Fuchsin has 2 hues, really this is only approximate
			//			MODx[0]=1.0-0.09997159;
			//			MODy[0]=1.0-0.73738605;
			//			MODz[0]=1.0-0.6680326;
			//			// Zero matrix
			//			MODx[1]= 0.0;
			//			MODy[1]= 0.0;
			//			MODz[1]= 0.0;
		...
		//only in Iqm version 
		if (myStain.equals("DAB NBTBCIP")){
			// DAB matrix
			MODx[0]= 1.0-0.275394768;
			MODy[0]= 1.0-0.708525;
			MODz[0]= 1.0-0.645100078;
			// Zero matrix
			MODx[1]= 0.0;
			MODy[1]= 0.0;
			MODz[1]= 0.0;		
			// NBTBCIP matrix
			MODx[2]= 1.0-0.693410988;
			MODy[2]= 1.0-0.649749738;
			MODz[2]= 1.0-0.307411858;
		}
		//only in Iqm version 
		if (myStain.equals("DAB")){
			// DAB matrix
			MODx[0]= 1.0-0.194090488;
			MODy[0]= 1.0-0.65181531;
			MODz[0]= 1.0-0.72566154;
			// Zero matrix
			MODx[1]= 0.0;
			MODy[1]= 0.0;
			MODz[1]= 0.0;
		...
		ImagePlus[] resultStack = new ImagePlus[3];
		resultStack[0] = new ImagePlus(title+"-(Colour_1)",outputstack[0]);
		resultStack[1] = new ImagePlus(title+"-(Colour_2)",outputstack[1]);
		resultStack[2] = new ImagePlus(title+"-(Colour_3)",outputstack[2]);
		IJ.run(resultStack[0], "8-bit", "");
		IJ.run(resultStack[1], "8-bit", "");
		IJ.run(resultStack[2], "8-bit", "");
