 ...
 * @since 2012 01
 */
public class IqmOpStackStatRIF implements RenderedImageFactory {

	public IqmOpStackStatRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpStackStatOpImage(pb.getRenderedSource(0),
