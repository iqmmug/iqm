 ...
 * @since 2012 06
 */
public class IqmOpFracScanRIF implements RenderedImageFactory {

	public IqmOpFracScanRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracScanOpImage(pb.getRenderedSource(0),
