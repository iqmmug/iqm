 ...
 * @since   2009 04
 */
public class IqmOpResizeRIF implements RenderedImageFactory {

	public IqmOpResizeRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpResizeOpImage(pb.getRenderedSource(0),
