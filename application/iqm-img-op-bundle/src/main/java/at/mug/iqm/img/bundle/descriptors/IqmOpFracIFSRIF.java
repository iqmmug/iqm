 ...
 * @since   2009 10
 */
public class IqmOpFracIFSRIF implements RenderedImageFactory {

	public IqmOpFracIFSRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpFracIFSOpImage(pb.getRenderedSource(0),
