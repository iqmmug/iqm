 ...
 * @since   2009 06
 */
public class IqmOpStatisticsRIF implements RenderedImageFactory {

	public IqmOpStatisticsRIF() {
	}
	...
	public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
		...
		// for large images
		return new IqmOpStatisticsOpImage(pb.getRenderedSource(0),
