 ...
 * @since 2012 11
 */
public class PlotGUI_FracHiguchi extends AbstractPlotOperatorGUI implements
		ChangeListener {
	...
	public PlotGUI_FracHiguchi() {
		...
		this.setTitle("Fractal Higuchi Dimension (Plot)");
		...
		this.getOpGUIContent().add(getJPanelNumK(),                getGBC_NumK());
	...
	private GridBagConstraints getGBC_NumK() {
		GridBagConstraints gbc_NumK = new GridBagConstraints();
		gbc_NumK.gridx = 0;
		gbc_NumK.gridy = 0;
		gbc_NumK.insets = new Insets(10, 0, 0, 0); // top left bottom right
	...
	private JPanel getJPanelNumK() {
		if (jPanelNumK == null) {
			...
			jPanelNumK.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), 
		               "Number of data series (delay)", TitledBorder.LEADING, TitledBorder.TOP, 
		               null, new Color(0, 0, 0)));
			jPanelNumK.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
