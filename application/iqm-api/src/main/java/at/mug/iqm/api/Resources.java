...
public class Resources {
	...
	private static final ResourceBundle IMAGEPATHS_BUNDLE = ResourceBundle
			.getBundle("api.protocol.imagePaths");
	 ...
	 * <code>IMAGEPATHS_BUNDLE</code>. It returns '!key!' if the required value
