 ...
 * <b>Changes</b>
 * <ul>
 * 	<li>2014 02 changed float to double for r
 * </ul>
 * 
 * @author Helmut Ahammer
 * @since     2012 10
 */
public class AppEntropy {
	 ...
	 *            1D data vector
	 * @param m
	 *            : number of new calculated time series (m = 2, Pincus et al.
	 *            1994)
	 * @return Vector of Series (vectors)
	 * 
	 */
	private Vector<Vector<Double>> calcNewSeries(Vector<Double> data1D, int m,
			int d) {
	 ...
	 * 
	 */
	private Vector<Integer> calcNumberOfCorrelations(
			Vector<Vector<Double>> newDataSeries, int m, double distR) {
	 ...
	 */
	private Vector<Double> calcLogCorrelations(
	 ...
	 * 
	 */
	private double calcSumOfCorrelation(Vector<Double> correlations, int m,
			int d) {
	 ...
	 * 
	 */
	public double calcAppEntropy(Vector<Double> data1D, int m, double r, int d) {
