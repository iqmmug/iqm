 ...
 * #%L
 * Project: IQM - API
 * File: ManagerListCellRendererRight.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class ManagerListCellRendererRight extends ManagerListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		int tankIdx = Application.getManager().getTankIndexInMainRight();
